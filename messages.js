...
const MSG = Object.freeze({
    ...
    GATE_STATUS: "GATE_STATUS", // Background replies

    // --- Instruct UI to do something ---
...
function validateMessage(msg) {
    ...
    switch (msg.type) {
        ...
        case MSG.GATE_STATUS: {
            ...
            if (typeof p.solvedToday !== "number") return { ok: false, error: "GATE_STATUS.payload.solvedToday must be number." };
            if (typeof p.goalCount !== "number") return { ok: false, error: "GATE_STATUS.payload.goalCount must be number." };
